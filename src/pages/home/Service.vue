    ...
    <el-row>
      <el-col :span="24">
        ...
        <el-button
          ...
          >确认删除</el-button
        >
        <el-button v-if="deleteCheckBoxVisible" @click="closeDeleteCheckBox"
          >取消</el-button
        >
      </el-col>
    </el-row>
    ...
    >
      ...
      <el-table-column fixed="right" label="操作" width="300">
        <template slot-scope="scope">
          <!-- 删除过程中，禁用其他操作 -->
          <el-button
            :disabled="deleteCheckBoxVisible"
            @click="
              form = { ...scope.row };
              dialogFormVisible = true;
            "
...
const tableItem = {
  date: "2021-10-07", // 日期
  name: "广园", // 姓名
  phone: "18970942881", // 电话
  address: "江西省南昌市南昌航空大学", // 地址
};
...
export default {
  ...
  methods: {
    ...
    // 打开选择项
    openDeleteCheckBox() {
      this.deleteCheckBoxVisible = true;
    },
    closeDeleteCheckBox() {
      this.deleteCheckBoxVisible = false;
    },
    // 切换选中的选项
    toggleChosenItem(id) {
